 ...
 * @version 1.0
 */
@Controller("rentInforController")
public class RentInforController extends BaseController {
	/** 模板路径 */
	private static final String TEMPLATE_PATH = "front/userCenter/productInforManage/rent";
	 ...
	 * 产品信息求购
	 */
	@RequestMapping(value = { "/rentInfor", "/rentInfor.jhtml" }, method = { RequestMethod.GET, RequestMethod.POST })
	public String userInforSale(@RequestParam(required = false, defaultValue = "1") int pageNum, // 审核页码
		...
		if (currentMember != null) {
			...
			pageable.getFilters().add(Filter.eq("productType", productTypeService.find(3l)));
			...
			pageable1.getFilters().add(Filter.eq("productType", productTypeService.find(3l)));
			...
			pageable2.getFilters().add(Filter.eq("productType", productTypeService.find(3l)));
			...
			pageable3.getFilters().add(Filter.eq("productType", productTypeService.find(3l)));
			...
			pageable4.getFilters().add(Filter.eq("productType", productTypeService.find(3l)));
			...
			return TEMPLATE_PATH + "/rentInfor";
		} else {
	...
	// 修改产品信息销售
	@RequestMapping(value = "/edit_rentInfor", method = { RequestMethod.GET, RequestMethod.POST })
	public String edit_rentInfor(HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		if (currentMember != null) {
			...
			return TEMPLATE_PATH + "/edit_user_pub_rent";
		} else {
			return "redirect:/login.jhtml";
		}
	}
	...
	// 修改客户商品销售
	@ResponseBody
	@RequestMapping(value = "/save_updateEdit_user_pub_rent", method = { RequestMethod.POST, RequestMethod.GET })
	public Map<String, Object> save_updateEdit_user_pub_rent(HttpServletRequest request, HttpServletResponse response,
			Model model) {
