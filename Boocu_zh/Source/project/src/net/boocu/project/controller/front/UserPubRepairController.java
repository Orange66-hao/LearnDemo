 ...
 * @version 1.0
 */
@Controller("userPubRepairController")
public class UserPubRepairController extends BaseController {
	/** 模板路径 */
	private static final String TEMPLATE_PATH = "front/userCenter/userPub/repair";
	 ...
	 * 客户产品维修
	 */
	@RequestMapping(value = { "/user_pub_repair", "/user_pub_repair.jhtml" }, method = { RequestMethod.GET,
			RequestMethod.POST })
	public String userPubRepair(HttpServletRequest request, ModelMap model, HttpServletResponse response) {
		...
		if (currentMember != null) {
			...
			return TEMPLATE_PATH + "/user_pub_repair";
		} else {
	 ...
	 * ajax 客户产品维修
	 */
	@RequestMapping(value = "/user_pub_repair/user_pub_repair", method = RequestMethod.POST)
	public @ResponseBody Message userPubRepair(HttpServletRequest request, HttpServletResponse response) {
		System.out.println("客户产品维修--------------");
