 ...
 * 2015年8月27日
 */
@Controller("productRepairFastController")
@RequestMapping("/admin/prodoctMng/fastPublish/repair")
public class ProductRepairFastController {
	
	private static final String TEM_PATH ="/template/admin/prodoctMng/fastPublish/repair";
	...
	//跳转到村实体添加页面
    @RequestMapping(value = "/add_fastPubRepair.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
    public String add_ProductRepair(HttpServletRequest request, HttpServletResponse response, Model model) {
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/save_fastPubRepair.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
    public Map<String,Object> saveProductRent(HttpServletRequest request, HttpServletResponse response, Model model) {
    	...
    	String fault = ReqUtil.getString(request, "falut", "");
    	...
    	productRepairEntity.setBuglokoEn(buglokoEn);
     ...
     * 传出参数:result（方法结果信息）
     */
    @RequestMapping(value = "/delete_fastPubRepair.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
    ...
    //跳转到实体更新页面
    @RequestMapping(value = "/edit_fastPubRepair.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
    public String editProductRepair(HttpServletRequest request, HttpServletResponse response, Model model) {
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/save_edit_fastPubRepair.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
    public Map<String,Object> saveEditProductRent(HttpServletRequest request, HttpServletResponse response, Model model) {
    	...
    	if(productRepairEntity != null){
        	...
        	productRepairEntity.getProductEntity().setRemain(remain);
        	productRepairEntity.setRepairPrice(repairPrice);
        	productRepairEntity.setRepairPriceUnit(PriceUnitEnum.valueOf(repairPriceUnit));
        	productRepairEntity.setRepairPriceType(CurrencyEnum.valueOf(repairPriceType) );
        	productRepairEntity.setMaintaindemo(maintaindemo);
