 ...
 * 2015年10月28日
 */
@Controller("projectNeedCusController")
@RequestMapping("/admin/prodoctMng/cusProMng/projectNeed")
public class ProjectNeedCusController {
	
	private static final String TEM_PATH ="/template/admin/prodoctMng/cusProMng/projectNeed";
	...
	//跳转到村实体添加页面
    @RequestMapping(value = "/add_cusPubProjectNeed.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/save_cusPubProjectNeed.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
     ...
     * 传出参数:result（方法结果信息）
     */
    @RequestMapping(value = "/delete_cusPubProjectNeed.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
    ...
    //跳转到实体更新页面
    @RequestMapping(value = "/edit_cusPubProjectNeed.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/save_edit_cusPubProjectNeed.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
