 ...
 * 2015年8月31日
 */
@Controller("productCusRepairController")
@RequestMapping("/admin/prodoctMng/cusProMng/repair")
public class ProductRepairCusController {
	
	private static final String TEM_PATH ="/template/admin/prodoctMng/cusProMng/repair";
	...
	//跳转到村实体添加页面
    @RequestMapping(value = "/add_cusPubRepair.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/save_cusPubRepair.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
    public Map<String,Object> saveProductRepair(HttpServletRequest request, HttpServletResponse response, Model model) {
     ...
     * 传出参数:result（方法结果信息）
     */
    @RequestMapping(value = "/delete_cusPubRepair.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
    ...
    //跳转到实体更新页面
    @RequestMapping(value = "/edit_cusPubRepair.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/save_edit_cusPubRepair.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
