...
/*			_btFechar.click(
				function () {
					$(_data.object).animate({opacity:0},300,function(){	$(_data.object).hide();});
...
/*			_btFechar.click(
					function () {
						$(_data.object).animate({opacity:0},300,function(){	$(_data.object).hide();destroy();});
						jQuery(document.body).css('overflow', 'auto');
						return false;
					}
				);*/
