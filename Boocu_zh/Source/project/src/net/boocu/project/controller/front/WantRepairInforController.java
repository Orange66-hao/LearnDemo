 ...
 * @version 1.0
 */
@Controller("wantRepairInforController")
public class WantRepairInforController extends BaseController {
	/** 模板路径 */
	private static final String TEMPLATE_PATH = "front/userCenter/productInforManage/wantRepair";
	 ...
	 * 产品信息求修
	 */
	@RequestMapping(value = { "/wantRepairInfor", "/wantRepairInfor.jhtml" }, method = { RequestMethod.GET,
			RequestMethod.POST })
	public String userInforSale(@RequestParam(required = false, defaultValue = "1") int pageNum, // 审核页码
		...
		if (currentMember != null) {
			...
			pageable.getFilters().add(Filter.eq("productType", productTypeService.find(6l)));
			...
			pageable1.getFilters().add(Filter.eq("productType", productTypeService.find(6l)));
			...
			pageable2.getFilters().add(Filter.eq("productType", productTypeService.find(6l)));
			...
			pageable3.getFilters().add(Filter.eq("productType", productTypeService.find(6l)));
			...
			pageable4.getFilters().add(Filter.eq("productType", productTypeService.find(6l)));
			...
			return TEMPLATE_PATH + "/wantRepairInfor";
		} else {
	...
	// 修改产品信息求修
	@RequestMapping(value = "/edit_wantRepairInfor", method = { RequestMethod.GET, RequestMethod.POST })
	public String edit_rentInfor(HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		if (currentMember != null) {
			...
			return TEMPLATE_PATH + "/edit_user_pub_wantRepair";
		} else {
			return "redirect:/login.jhtml";
		}
	}
	...
	// 修改客户商品销售
	@ResponseBody
	@RequestMapping(value = "/save_updateEdit_user_pub_wantRepair", method = { RequestMethod.POST, RequestMethod.GET })
	public Map<String, Object> save_updateEdit_user_pub_repair(HttpServletRequest request, HttpServletResponse response,
			Model model) {
