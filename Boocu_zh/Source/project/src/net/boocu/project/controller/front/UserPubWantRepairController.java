 ...
 * Controller - 客户产品求修
 * 
 * @author deng 20151117
 * @version 1.0
 */
@Controller("userPubWantRepairController")
public class UserPubWantRepairController extends BaseController {
	/** 模板路径 */
	private static final String TEMPLATE_PATH = "front/userCenter/userPub/wantRepair";
	 ...
	 * 客户产品求修
	 */
	@RequestMapping(value = { "/user_pub_wantRepair", "/user_pub_wantRepair.jhtml" }, method = { RequestMethod.GET,
			RequestMethod.POST })
	public String userPubRepair(HttpServletRequest request, ModelMap model, HttpServletResponse response) {
		// 已登录的会员名
		...
		if (currentMember != null) {
			...
			return TEMPLATE_PATH + "/user_pub_wantRepair";
		} else {
	 ...
	 * ajax 客户产品求修
	 */
	@RequestMapping(value = "/user_pub_wantRepair/user_pub_wantRepair", method = RequestMethod.POST)
	public @ResponseBody Message userPubWantRepair(HttpServletRequest request, HttpServletResponse response) {
		System.out.println("客户产品求修--------------");
