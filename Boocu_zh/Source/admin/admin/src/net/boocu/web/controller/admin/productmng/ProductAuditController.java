...
@RequestMapping("/admin/prodoctMng/productAudit")
public class ProductAuditController {

	private static final String TEM_PATH = "/template/admin/prodoctMng/productAudit";
	...
	@RequestMapping(value = "toProductAuditList.jspx", method = { RequestMethod.POST, RequestMethod.GET })
	public String toList(HttpServletRequest request, HttpServletResponse response, Model model) {
		return TEM_PATH + "/productAuditlist";
	}
	...
	public void nAuditData(HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		String state = ReqUtil.getString(request, "state", "0");
		...
		Page<ProductEntity> page = productAuditService.findProductAuditPage(pageable, params);
		...
		for (ProductEntity item : productEntities) {
			...
			jsonConfig.setExcludes(new String[]{"industryClassEntity","industryClassEntities"});
			jsonConfig.setJsonPropertyFilter(new PropertyFilter() {
				@Override
				public boolean apply(Object source, String proName, Object arg2) {
					return arg2 == null || "productEntity".equals(proName) || "autoTest".equals(proName)|| "proSynopsis".equals(proName)
							|| "projectNeed".equals(proName) || "productTest".equals(proName)
							|| "calibration".equals(proName) || "requireTest".equals(proName)||"addressEntity".equals(proName)||"productclassEntity".equals(proName);
				}
			});
	...
	public void audit(HttpServletRequest request, HttpServletResponse response, Model model, Long[] id) {
		...
		for (int i = 0; i < ids.length; i++) {
			ProductEntity productEntity = productAuditService.find(ids[i]);
			productEntity.setApprStatus(1);
			productAuditService.update(productEntity);
		}
		Map<String, Object> result = new HashMap<String, Object>();
		result.put("result", 1);
	...
	public void delete(HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		if (ids != null && ids.length > 0) {
			for (Long id : ids) {
				ProductEntity productEntity = productAuditService.find(id);
	...
	public String edit_productAudit(HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		if (productEntity != null) {
			...
			if (productEntity.getProductType().getId() == 1l) {
				...
				ProductTestEntity productTestEntity = productTestService
						.find(Filter.eq("productEntity", productEntity));
				model.addAttribute("item", productTestEntity);
				List<InstrumentEntity> instrumentEntities = instrumentService
						.findList(Filter.eq("productTest", productTestEntity));
				// 获取instrumentEntities 第一个元素
				if (instrumentEntities.size() > 0 && instrumentEntities != null) {
					InstrumentEntity instrumentEntity = instrumentEntities.get(0);
					model.addAttribute("instrumentEntity", instrumentEntity);
				...
				RequireTestEntity requireTestEntity = requireTestService
						.find(Filter.eq("productEntity", productEntity));
				model.addAttribute("item", requireTestEntity);
				List<InstrumentEntity> instrumentEntities = instrumentService
						.findList(Filter.eq("requireTest", requireTestEntity));
				// 获取instrumentEntities 第一个元素
				if (instrumentEntities.size() > 0 && instrumentEntities != null) {
					InstrumentEntity instrumentEntity = instrumentEntities.get(0);
					model.addAttribute("instrumentEntity", instrumentEntity);
				...
				CalibrationEntity calibrationEntity = calibrationService
						.find(Filter.eq("productEntity", productEntity));
				model.addAttribute("item", calibrationEntity);
				List<InstrumentEntity> instrumentEntities = instrumentService
						.findList(Filter.eq("calibration", calibrationEntity));
				// 获取instrumentEntities 第一个元素
				if (instrumentEntities.size() > 0 && instrumentEntities != null) {
					InstrumentEntity instrumentEntity = instrumentEntities.get(0);
					model.addAttribute("instrumentEntity", instrumentEntity);
	...
	// 修改商品销售
	@ResponseBody
	@RequestMapping(value = "/update_editSale_productAudit.jhtml", method = { RequestMethod.POST, RequestMethod.GET })
	public Map<String, Object> update_editSale_productAudit(HttpServletRequest request, String[] indClassId,
		...
		int longTerm = ReqUtil.getInt(request, "longTerm", 0);
	...
	public Map<String, Object> update_editBuy_productAudit(HttpServletRequest request, String[] indClassId,
			HttpServletResponse response, Model model) {
		long id = ReqUtil.getLong(request, "id", 0l);
		String proName = ReqUtil.getString(request, "proName", "");
		String status = ReqUtil.getString(request, "status", "");
	...
	public Map<String, Object> update_editRent_productAudit(HttpServletRequest request, String[] indClassId,
			HttpServletResponse response, Model model) {
		long id = ReqUtil.getLong(request, "id", 0l);
		String proName = ReqUtil.getString(request, "proName", "");
		long brandId = ReqUtil.getLong(request, "brandId", 0l);
	...
	// 修改商品求租
	@ResponseBody
	@RequestMapping(value = "/update_editWantRent_productAudit.jspx", method = { RequestMethod.POST,
			RequestMethod.GET })
	public Map<String, Object> update_editWantRent_productAudit(HttpServletRequest request, String[] indClassId,
			HttpServletResponse response, Model model) {
		long id = ReqUtil.getLong(request, "id", 0l);
		String proName = ReqUtil.getString(request, "proName", "");
		long brandId = ReqUtil.getLong(request, "brandId", 0l);
	...
	public Map<String, Object> update_editRepair_productAudit(HttpServletRequest request, String[] indClassId,
			HttpServletResponse response, Model model) {
		long id = ReqUtil.getLong(request, "id", 0l);
		String proName = ReqUtil.getString(request, "proName", "");
		long brandId = ReqUtil.getLong(request, "brandId", 0l);
	...
	// 修改商品求修
	@ResponseBody
	@RequestMapping(value = "/update_editWantRepair_productAudit.jspx", method = { RequestMethod.POST,
			RequestMethod.GET })
	public Map<String, Object> update_editWantRepair_productAudit(HttpServletRequest request, String[] indClassId,
			HttpServletResponse response, Model model) {
		long id = ReqUtil.getLong(request, "id", 0l);
		String proName = ReqUtil.getString(request, "proName", "");
		long brandId = ReqUtil.getLong(request, "brandId", 0l);
	...
	public String edit_memberPrice(HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		model.addAttribute("weben", ReqUtil.getLong(request, "weben", 0l));
	...
	public Map<String, Object> save_edit_memberPrice(HttpServletRequest request, HttpServletResponse response,
			Model model) {
		Long id = ReqUtil.getLong(request, "id", 0l);
		// 发货周期
		BigDecimal sendCycle = new BigDecimal(ReqUtil.getLong(request, "sendCycle", 0l));
