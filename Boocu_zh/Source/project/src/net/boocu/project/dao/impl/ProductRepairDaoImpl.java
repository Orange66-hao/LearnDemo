...
@Repository("productRepairDaoImpl")
public class ProductRepairDaoImpl extends BaseDaoImpl<ProductRepairEntity, Long> implements ProductRepairDao {
	...
	public Page<ProductRepairEntity> getProductRepairPage(Pageable pageable, Map<String, Object> map) {
        ...
        CriteriaQuery<ProductRepairEntity> query = 
        		builder.createQuery(ProductRepairEntity.class);
        
        Root<ProductRepairEntity> root = query.from(ProductRepairEntity.class);
	...
	/* (non-Javadoc)
	 * @see net.boocu.project.dao.ProductRepairDao#getRepairInfo(java.util.Map)
	 */
	@Override
	...
	public Page<ProductRepairEntity> findProductRepairPage(Pageable pageable,
        ...
        // 创建条件查询
        CriteriaQuery<ProductRepairEntity> criteriaQuery = criteriaBuilder.createQuery(ProductRepairEntity.class);
        
        // 设置查询ROOT
        Root<ProductRepairEntity> root = criteriaQuery.from(ProductRepairEntity.class);
