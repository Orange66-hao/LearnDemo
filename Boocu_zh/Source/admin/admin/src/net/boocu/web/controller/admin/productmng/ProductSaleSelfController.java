 ...
 * 2015年8月12日
 */
@Controller("productSelfSaleController")
@RequestMapping("/admin/prodoctMng/selfPublish/sale")
public class ProductSaleSelfController {
	
	private static final String TEM_PATH ="/template/admin/prodoctMng/selfProMng/sale";
	...
	//跳转到村实体添加页面
    @RequestMapping(value = "/add_selfPubSale.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/save_selfPubSale.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
     ...
     * 传出参数:result（方法结果信息）
     */
    @RequestMapping(value = "/delete_selfPubSale.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
    ...
    //跳转到实体更新页面
    @RequestMapping(value = "/edit_selfPubSale.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/save_edit_selfPubSale.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
    public Map<String,Object> saveEditProductSale(HttpServletRequest request, HttpServletResponse response, Model model) {
    	...
    	if(productSaleEntity != null){
	    	...
	    	productSaleEntity.getProductEntity().setProductType(producttypeService.find(1l));
