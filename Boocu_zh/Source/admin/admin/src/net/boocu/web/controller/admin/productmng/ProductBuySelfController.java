 ...
 * 2015年8月12日
 */
@Controller("productSelfBuyController")
@RequestMapping("/admin/prodoctMng/selfPublish/buy")
public class ProductBuySelfController {
	
	private static final String TEM_PATH ="/template/admin/prodoctMng/selfProMng/buy";
	...
	//跳转到村实体添加页面
    @RequestMapping(value = "/add_selfPubBuy.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/save_selfPubBuy.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
     ...
     * 传出参数:result（方法结果信息）
     */
    @RequestMapping(value = "/delete_selfPubBuy.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
    ...
    //跳转到实体更新页面
    @RequestMapping(value = "/edit_selfPubBuy.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/save_edit_selfPubBuy.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
