 ...
 * @version 1.0
 */
@Controller("userPubWantRentController")
public class UserPubWantRentController extends BaseController {
	/** 模板路径 */
	private static final String TEMPLATE_PATH = "front/userCenter/userPub/wantRent";
	 ...
	 * 客户产品求租
	 */
	@RequestMapping(value = { "/user_pub_wantRent", "/user_pub_wantRent.jhtml" }, method = { RequestMethod.GET,
			RequestMethod.POST })
	public String userPubWantRent(HttpServletRequest request, ModelMap model, HttpServletResponse response) {
		// 已登录的会员名
		...
		if (currentMember != null) {
			...
			return TEMPLATE_PATH + "/user_pub_wantRent";
		} else {
	 ...
	 * ajax 客户产品求租
	 */
	@RequestMapping(value = "/user_pub_wantRent/user_pub_wantRent", method = RequestMethod.POST)
