 ...
 * 2015年8月12日
 */
@Controller("productSelfWantRentController")
@RequestMapping("/admin/prodoctMng/selfPublish/wantRent")
public class ProductWantRentSelfController {
	
	private static final String TEM_PATH ="/template/admin/prodoctMng/selfProMng/wantRent";
	...
	//跳转到村实体添加页面
    @RequestMapping(value = "/add_selfPubWantRent.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/save_selfPubWantRent.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
    ...
    /**
     * 
     * 方法:删除选中ProductWantRentEntity（广告本身实体 ）并更新数据库
     * 传入参数:id（选中实体的id数组）
     * 传出参数:result（方法结果信息）
     */
    @RequestMapping(value = "/delete_selfPubWantRent.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
    ...
    //跳转到实体更新页面
    @RequestMapping(value = "/edit_selfPubWantRent.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/save_edit_selfPubWantRent.jspx",method ={ RequestMethod.POST, RequestMethod.GET})
